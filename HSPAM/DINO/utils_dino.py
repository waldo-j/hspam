...
def load_pretrained_weights(
    model, pretrained_weights, checkpoint_key, checkpoint, patch_size
):
    if os.path.isfile(pretrained_weights):
        ...
        url = None
        if checkpoint == "vit_small" and patch_size == 16:
            url = "dino_deitsmall16_pretrain/dino_deitsmall16_pretrain.pth"
        elif checkpoint == "vit_small" and patch_size == 8:
            url = "dino_deitsmall8_pretrain/dino_deitsmall8_pretrain.pth"
        elif checkpoint == "vit_base" and patch_size == 16:
            url = "dino_vitbase16_pretrain/dino_vitbase16_pretrain.pth"
        elif checkpoint == "vit_base" and patch_size == 8:
            url = "dino_vitbase8_pretrain/dino_vitbase8_pretrain.pth"
        elif checkpoint == "xcit_small_12_p16":
            url = "dino_xcit_small_12_p16_pretrain/dino_xcit_small_12_p16_pretrain.pth"
        elif checkpoint == "xcit_small_12_p8":
            url = "dino_xcit_small_12_p8_pretrain/dino_xcit_small_12_p8_pretrain.pth"
        elif checkpoint == "xcit_medium_24_p16":
            url = (
                "dino_xcit_medium_24_p16_pretrain/dino_xcit_medium_24_p16_pretrain.pth"
            )
        elif checkpoint == "xcit_medium_24_p8":
...
def load_pretrained_linear_weights(linear_classifier, checkpoint, patch_size):
    url = None
    if checkpoint == "vit_small" and patch_size == 16:
